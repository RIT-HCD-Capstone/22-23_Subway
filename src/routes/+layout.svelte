...
<nav
	class="flex flex-row w-full h-16 fixed p-4 text-white space-x-4 py-10 bg-slate-800/80 justify-start items-center transition-colors duration-200 ease-in-out"
>
	<a href="/">
